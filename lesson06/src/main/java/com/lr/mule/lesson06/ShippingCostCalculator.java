...
public class ShippingCostCalculator  implements Initialisable, Callable {
	boolean initialized = false;
	EndpointBuilder errorProcessorChannelBuilder;
	OutboundEndpoint errorProcessorChannel;
	
	public void setErrorProcessorChannel(EndpointBuilder errorProcessorChannelBuilder) {//<co id="lis_06_component-lifecycle-1_co"/> 
