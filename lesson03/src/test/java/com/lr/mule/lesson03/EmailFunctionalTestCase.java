...
public class EmailFunctionalTestCase extends FunctionalTestCase {
    ...
    protected String getConfigResources() {
        return "globle.xml,04_email-config.xml";
    }
    ...
    protected void doSetUp() throws Exception {
        ...
        muleContext.registerListener(new EndpointMessageNotificationListener() {
            public void onNotification(final ServerNotification notification) {
                if ("2.sendExpenseReportEmails".equals(notification.getResourceIdentifier())
    ...
    public void testCanSendEmail() throws Exception {
        ...
        System.out.println("消息长度为：：：：：：：：：：：：：：：：：：：：：：：：：：："+smtpServer.getReceivedMessages().length);
        //等待服务器收到消息，并响应到smtpServer.getReceivedMessages()中（源码中并没有此问题，应该是latch的countDown出的问题）
        Thread.sleep(2000);
        System.out.println("消息长度为：：：：：：：：：：：：：：：：：：：：：：：：：：："+smtpServer.getReceivedMessages().length);
